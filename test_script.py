...
if __name__ == "__main__":
    llm_rules: str = (
        load_rules_file("/users/yugm2/cs537-final-project/data/llmrules.txt")
    )
    rejudge_responses(
    experiment_file="/users/yugm2/cs537-final-project/experiments/outputs/exp1_SmartHomeChildSafety_gemini_bow-True_results.json",
    dataset_file="/users/yugm2/cs537-final-project/data/dataset1.json",
    save_filepath="/users/yugm2/cs537-final-project/experiments/outputs/exp1_SmartHomeChildSafety_gemini_bow-True_results_rejudged.json",
    llm_rules=llm_rules
)
